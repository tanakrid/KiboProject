...
public class YourService extends KiboRpcService {
    ...
    protected void runPlan1(){
        ...
        moveToWrapper(11.5, -5.7, 4.5, 0, 0, 0, 1, 2);

        moveToWrapper(11, -6, 5.55, 0, -0.7071068, 0, 0.7071068, 3);


        moveToWrapper(10.5, -6.2, 5.55, 0, 0, 0.7071068, -0.7071068, 4);
        moveToWrapper(10.5, -6.8, 5.55, 0, 0, 0.7071068, -0.7071068, 5);
        moveToWrapper(11, -6.8, 5.55, 0, 0, 0.7071068, -0.7071068, 6);


        moveToWrapper(11, -7.7, 5.55, 0, -0.7071068, 0, 0.7071068, 7);

        moveToWrapper(10.30, -7.5, 4.7, 0, 0, 1, 0, 8);
